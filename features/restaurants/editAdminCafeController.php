<?php 
	...
	if(isset($_POST['edit']))
	{
		...
		if(isset($_POST['cafe_approved']))$cafe->setApproved($_POST['cafe_approved']);else $cafe->setApproved(0);
		if(isset($_POST['cafe_verified']))$cafe->setVerified($_POST['cafe_verified']);else $cafe->setVerified(0);
		...
		if($fields->hasErrors())
		{
			require_once 'admin_views/edit_cafe.php';
			return;
		}
		else
		{
