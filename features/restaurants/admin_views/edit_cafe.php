    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
         ...
         <div id="map" style="height: 400px; width: 400px;"></div>
            ...
            <div class="checkbox">
                <label for="cafe_approved">This cafe is approved for public view</label>
                <input type="checkbox" name="cafe_approved" style="position: relative;left:25px;opacity: 100;" value="1" <?php echo $cafe->getApproved() ? 'checked':'';?> >
                
            </div>
            <div class="checkbox">
                <label for="cafe_verified">This cafe is verified</label> 
                <input type="checkbox" name="cafe_verified" style="position: relative;left:25px;opacity: 100;" value="1" <?php echo $cafe->getVerified() ? 'checked':'';?> >
            </div>
            <button type="submit" name="edit">Save</button>
    </form>
    
    <a href="admin.php?feature=cafes&action=deletecafe&id=<?php echo($cafe->getId());?>"> <button type="button" name="detele">Delete</button></a>
    
    <a href="admin.php?feature=cafes&action=viewlist">Return to list</a>
    <script>
        function initMap() {
