    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
         ...
         <div id="map" style="height: 400px; width: 400px;"></div>
            ...
            <div class="checkbox">
                <label for="place_approved">This place is approved for public view</label>
                <input type="checkbox" name="place_approved" style="position: relative;left:25px;opacity: 100;" value="1" <?php echo $place->getApproved() ? 'checked':'';?> >
                
            </div>
            <div class="checkbox">
                <label for="place_verified">This place is verified</label> 
                <input type="checkbox" name="place_verified" style="position: relative;left:25px;opacity: 100;" value="1" <?php echo $place->getVerified() ? 'checked':'';?> >
            </div>
            <button type="submit" name="edit">Save</button>
    </form>
    
    <a href="admin.php?feature=places&action=deleteplace&id=<?php echo($place->getId());?>"> <button type="button" name="detele">Delete</button></a>
    
    <a href="admin.php?feature=places&action=viewlist">Return to list</a>
    <script>
        function initMap() {
