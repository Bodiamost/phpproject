    ...
    <form action="" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <div>
                ...
                <?php echo $fields->getField('event_cat')->getHTML();?>
            </div>
            <div>
                <label for="event_image">Select image to upload:</label>
                <input type="file" name="event_image" id="event_image">
                <?php echo $fields->getField('event_image')->getHTML();?>
            </div>
            <div>
                <label for="event_desc">Description:</label>
                <textarea name="event_desc" placeholder=""><?php echo($event->getDesc());?></textarea>
                <?php echo $fields->getField('event_desc')->getHTML();?>
            </div>   
            <div>
            ...
            <div>
                ...
                <?php echo $fields->getField('event_contact')->getHTML();?>
            </div>
            <div>
        ...
        <?php //echo $fields->getField('event_lng')->getHTML();?>
    ...
    <script>
        function initMap() {
            ...
            if(document.getElementById("latInput").value=='0'||document.getElementById("latInput").value['lng']=='0') 
                ...
                uluru = {lat: <?php echo($event->getLat());?>, lng: <?php echo( $event->getLng());?>};      
