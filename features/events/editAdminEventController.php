<?php 
	...
	if(isset($_POST['edit']))
	{
		...
		if(isset($_POST['event_approved']))$event->setApproved($_POST['event_approved']);else $event->setApproved(0);
		if(isset($_POST['event_verified']))$event->setVerified($_POST['event_verified']);else $event->setVerified(0);
		...
		if($fields->hasErrors())
		{
			require_once 'admin_views/edit_event.php';
			return;
		}
		else
		{
