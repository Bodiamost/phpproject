    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <fieldset>
         ...
         <div id="map" style="height: 400px; width: 400px;"></div>
            ...
            <div class="checkbox">
                <label for="event_approved">This event is approved for public view</label>
                <input type="checkbox" name="event_approved" style="position: relative;left:25px;opacity: 100;" value="1" <?php echo $event->getApproved() ? 'checked':'';?> >
                
            </div>
            <div class="checkbox">
                <label for="event_verified">This event is verified</label> 
                <input type="checkbox" name="event_verified" style="position: relative;left:25px;opacity: 100;" value="1" <?php echo $event->getVerified() ? 'checked':'';?> >
            </div>
            <button type="submit" name="edit">Save</button>
    </form>
    
    <a href="admin.php?feature=events&action=deleteevent&id=<?php echo($event->getId());?>"> <button type="button" name="detele">Delete</button></a>
    
    <a href="admin.php?feature=events&action=viewlist">Return to list</a>
    <script>
        function initMap() {
