...
if(isset($_POST['update'])){
    $id = $_POST['id'];
    require_once '../connect.php';$db = Connect::dbConnect();//require_once 'database.php';
...
if(isset($_POST['upd'])){
    ...
    $row = $pdostmt->execute();
    //echo " updated " . $row;
    header("Location: ../../admin.php?feature=faq");//header("Location: listfaq.php");
}
?>
...
<h3>Update List</h3>
<form action="updatelist.php" method="post"><!--<form action="updatelist.php" method="post">-->
